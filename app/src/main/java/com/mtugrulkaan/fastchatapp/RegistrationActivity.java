package com.mtugrulkaan.fastchatapp;
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                if(imageUri!=null)
                                {
                                    ...
                                    String staus="Hey There I'm Using This Application";
                                    imageURI="https://firebasestorage.googleapis.com/v0/b/fastchatapp-98a17.appspot.com/o/profile_image.png?alt=media&token=85e0b16d-7888-4756-839c-ee39f11367f6";
                                    Users users=new Users(auth.getUid(),name,email,imageURI,staus);
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
